...
const (
	...
	CONSUMER_ENTITLEDCATALOGITEMS        = CONSUMER + "/entitledCatalogItems"
	...
	CREATE_ENTITLEDCATALOGITEM_API       = CONSUMER_ENTITLEDCATALOGITEMS + "/" + "%s" + "/requests"
	GET_ENTITLEDCATALOGITEM_TEMPLATE_API = CREATE_ENTITLEDCATALOGITEM_API + "/template"
)
